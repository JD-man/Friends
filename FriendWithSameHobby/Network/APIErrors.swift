...
enum ReportUserError: Int, CustomError {
    case unknownError = -1
    case tokenError = 401
    case unregistered = 406
    case serverError = 500
...
enum UserShopError: Int, CustomError {
    case unknownError = -1
    case tokenError = 401
    case unregistered = 406
    case serverError = 500
...
enum UpdateImageError: Int, CustomError {
    case unknownError = -1
    case notPurchased = 201
    case tokenError = 401
    case unregistered = 406
    case serverError = 500
    case clientError = 501
...
enum CompletePurchaseError: Int, CustomError {
    case unknownError = -1
    case invalidReceipt = 201
    case tokenError = 401
    case unregistered = 406
    case serverError = 500
    case clientError = 501
